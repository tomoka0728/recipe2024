                ...
                <section class="content">
                    ...
                    <div class="payment-method">
                        <div class="mt-2 space-y-2 mb-10">
                            <!-- クレジットカード -->
                            <label
                                class="w-2/3 flex items-center space-x-2 p-3 border rounded-md cursor-pointer transition duration-200 hover:bg-red-100 {{ old('method') == 'credit' ? 'bg-red-100 border-red-500' : 'border-gray-300' }}">
                                <input type="radio" name="method" value="credit" class="hidden peer"
                                    {{ old('method') == 'credit' ? 'checked' : '' }}>
                                <div
                                    class="w-5 h-5 border-2 rounded-full flex items-center justify-center border-gray-400 peer-checked:border-red-500">
                    ...
                    <div class="payment-method">
                        <div class="mt-2 space-y-2 mb-10">
                            <div class="mt-2 p-3 border rounded-md bg-gray-100">
                                <span
                                    class="text-lg font-semibold text-gray-800">現在のポイント：　{{ Auth::user()->points }}pt</span>
                            </div>

                            <div class="mt-4 space-y-2">
                                <!-- ポイントを利用する -->
                                <label
                                    class="w-2/3 flex items-center space-x-2 cursor-pointer transition duration-200 peer-checked:border-black peer-checked:text-black">
                                    <input type="radio" name="point" value="use" class="hidden peer"
                                        id="use-point">
                                    <div
                                        class="w-5 h-5 border-2 rounded-full flex items-center justify-center border-gray-400 peer-checked:border-red-500">
                                        <div class="w-3 h-3 bg-transparent rounded-full peer-checked:bg-red-500"></div>
                                    ...
                                    <input type="number" pattern="^[0-9]+$" min="0" name="use_point"
                                        ...
                                        class="w-50 p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-400 peer-checked:disabled:opacity-50">
                                    pt
                            </div>
                            </label>
                            ...
                            <div class="mt-4">
                                ...
                                <label
                                    class="w-2/3 flex items-center space-x-2 cursor-pointer transition duration-200 peer-checked:border-black peer-checked:text-black">
                                    <input type="radio" name="point" value="not_use" class="hidden peer"
                                        id="not-use-point">
                                    <div
                                        class="w-5 h-5 border-2 rounded-full flex items-center justify-center border-gray-400 peer-checked:border-red-500">
                                        <div class="w-3 h-3 bg-transparent rounded-full peer-checked:bg-red-500"></div>
