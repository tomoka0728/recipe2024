...
<x-guest-layout>
    ...
    <form method="POST" action="{{ route('admin.register') }}" novalidate class="custom-form">
        @csrf
        ...
        <div class="rq-box">
            ...
            <div class="flex items-center justify-center mt-10 mb-20">
                <a class="no-underline text-sm text-gray-500 hover:text-gray-900 rounded-md" href="{{ route('admin.login') }}">
