<header class="text-gray-600 body-font pt-4">
    <div class="container mx-auto px-4 flex flex-wrap flex-col md:flex-row items-center">
        ...
        <form id="header-search-form" method="GET"
            ...
            class="flex md:ml-auto md:mr-auto items-center text-base justify-center">
            {{-- ラジオボタン --}}
        ...
        <nav>
            <ul
                class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white  items-end justify-center">
                @auth
                    <li class="flex flex-col items-center">
                        <a href="{{ route('mypage') }}"
                            class="flex flex-col items-center block py-2 px-3 text-gray-900 text-xs rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-gray-300 md:p-0 ">
        ...
        <ul
            ...
            <li class="flex flex-col items-center ml-8">
                <a href="{{ route('cart.show') }}"
                    ...
                    @endphp
                    @if ($cartCount && count($cartCount) > 0)
                        {{-- カート内にアイテムがあれば表示 --}}
                        <span
                            class="absolute top-6 right-2 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full">
            ...
            <ul class="inline-flex list-none items-center w-full justify-center">
                <li>
                    <a href="{{ route('ingredients.index', ['search_type' => 'ingredient']) }}"
                        class="mr-1 rounded-md px-4 py-1 text-base text-rose-950 ring-offset-2 ring-offset-current transition duration-500 ease-in-out">食材</a>
                    <span class="mx-1 border-l border-yellow-900/20 h-5"></span>
                </li>
                <li>
                    <a href="{{ route('recipes.index', ['search_type' => 'recipe']) }}"
                        class="mr-1 rounded-md px-4 py-1 text-base text-rose-950 ring-offset-2 ring-offset-current transition duration-500 ease-in-out">レシピ</a>
                    <span class="mx-1 border-l border-yellow-900/20 h-5"></span>
                </li>
                <li>
                    <a href="{{ route('column') }}"
                        class="mr-1 rounded-md px-4 py-1 text-base text-rose-950 ring-offset-2 ring-offset-current transition duration-500 ease-in-out">読みもの</a>
                    <span class="mx-1 border-l border-yellow-900/20 h-5"></span>
                </li>
                <li>
                    <a href="{{ url('/special-feature') }}"
                        class="mr-1 rounded-md px-4 py-1 text-base text-rose-950 ring-offset-2 ring-offset-current transition duration-500 ease-in-out">特集</a>
                    <span class="mx-1 border-l border-yellow-900/20 h-5"></span>
                </li>
                <li>
                    <a href="#"
                        class="mr-1 rounded-md px-4 py-1 text-base text-rose-950 ring-offset-2 ring-offset-current transition duration-500 ease-in-out">ブックマーク</a>
                </li>
            </ul>
        </div>
    </div>
