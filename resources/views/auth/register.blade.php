    ...
    <form method="POST" action="{{ route('register') }}" novalidate class="custom-form">
        ...
        <div class="rq-box">
            ...
            <div class="flex items-center justify-end mt-4 mb-20">
                <a class="no-underline text-sm text-brown-600 hover:text-brown-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('login') }}">
