...
return [
    ...
    'zipcode.required_if' => '郵便番号を入力してください。',
    'zipcode.regex' => '郵便番号は7桁の数字で入力してください。',
    'prefectures.required_if' => '都道府県を選択してください。',
    'city.required_if' => '市区町村を入力してください。',
    'address.required_if' => '住所を入力してください。',
    'phone.required_if' => '電話番号を入力してください。',
    'phone.regex' => '電話番号は10桁または11桁の数字で入力してください。',
    'method.required' => '支払い方法を選択してください。',
    'point.required' => 'ポイント利用の有無を選択してください。',
    'point.in' => 'ポイント利用の選択が不正です。',
    'use_point.integer' => 'ポイントは整数で入力してください。',
    'use_point.min' => 'ポイントは0以上で入力してください。',
